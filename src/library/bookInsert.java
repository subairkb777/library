 ...
 * @author Zubair
 */
public class bookInsert extends javax.swing.JDialog {

    /**
     * Creates new form bookInsert
     */
    public bookInsert(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                bookInsert dialog = new bookInsert(new javax.swing.JFrame(), true);
