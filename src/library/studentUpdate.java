 ...
 * @author Zubair
 */
public class studentUpdate extends javax.swing.JDialog {

    /**
     * Creates new form studentUpdate
     */
    public studentUpdate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                studentUpdate dialog = new studentUpdate(new javax.swing.JFrame(), true);
